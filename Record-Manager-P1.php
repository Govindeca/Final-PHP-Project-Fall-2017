...
<table>
    <tr>
        <th>Perform Operations for Record-Manager-P1:</th>
    </tr>
    <tr>
        <td><a href="display-P1.php">(R)ead Display All Users </a></td>
    </tr>
    <?php if (isUserLoggedIn()) { ?>
        ...
        <tr>
            <td><a href="display-P1.php"> (U)pdate User Record</a></td>
        </tr>
        <tr>
            <td><a href="display-P1.php"> (D)Delete User Record</a></td>
        </tr>
    <?php } ?>
</table>
</body>
